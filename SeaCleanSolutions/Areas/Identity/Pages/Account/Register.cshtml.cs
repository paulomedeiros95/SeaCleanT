...
namespace SeaCleanSolutions.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new SeaCleanSolutionsUser {FullName=Input.FullName, Positions=Input.Position, FirstName=Input.FirstName, EmailConfirmed=true, UserName = Input.Email, Email = Input.Email };
